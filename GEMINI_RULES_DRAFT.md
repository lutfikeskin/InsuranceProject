...
> [!NOTE]
> This is a draft of the project rules for the AI coding assistant.
> Review this document to ensure it aligns with your requirements before renaming it to `project-rules.md` or adding it to your system prompts.
